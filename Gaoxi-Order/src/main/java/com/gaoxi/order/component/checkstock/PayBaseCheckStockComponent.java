...
public class PayBaseCheckStockComponent extends BaseCheckStockComponent {
     ...
     */
    private void setIntoContext(OrdersEntity ordersEntity, OrderProcessContext orderProcessContext) {
        ...
        // 插入支付方式
        orderInsertReq.setPayModeCode(ordersEntity.getPayModeEnum().getCode());
